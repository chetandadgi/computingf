...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#"><p>Computing Semantic Similarity of Concepts in Knowledge Graphs</p></a>
    </div>
    <ul class="nav navbar-nav">
        <li><a href="AHome.jsp"><p>Home</p></a></li>
      <li><a href="UserDetails.jsp"><p>View All Users</p></a></li>
      <li><a href="PublisherDetails.jsp"><p>View All Publishers</p></a></li>
      <li class="active"><a href="TextDetails.jsp"><p>Text Details</p></a></li>
		...
		<tbody>
			...
			<%
				try {
					...
					ResultSet rs;
					String sql = "select * from content_upload "; /* where username='"+user+"' */
