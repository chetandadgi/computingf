...
<!-- 				<li class="active"><a href="ImageUpload.jsp"><p>Upload Image </p></a></li>
...
<div class="container-fluid">
 ...
 <div class="col-sm-6">
			...
			<div class="form-group">
				<label for="upload"><p>Select File:</p></label> <input type="file"
					class="form-control" name="upload" id="image"
					placeholder="Upload Image" value="upload" required>
			</div>
</div>
...
<%
			...
			<!-- <div>
				<a href="PHome.jsp" onclick="login">Back</a>
			</div> -->
